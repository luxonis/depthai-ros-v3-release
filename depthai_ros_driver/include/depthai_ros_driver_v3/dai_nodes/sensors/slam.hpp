...
#include "depthai_ros_msgs_v3/srv/set_local_transform.hpp"
...
class Slam : public BaseNode {
   ...
   private:
    ...
    void setLocalTransformCB(const depthai_ros_msgs_v3::srv::SetLocalTransform::Request::SharedPtr req,
    ...
    rclcpp::Service<depthai_ros_msgs_v3::srv::SetLocalTransform>::SharedPtr setLocalTransformSrv;
